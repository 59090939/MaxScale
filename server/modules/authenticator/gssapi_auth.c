...
const char create_sql[] = "CREATE TABLE IF NOT EXISTS " GSSAPI_TABLE_NAME
                          "(user varchar(255), host varchar(255), db varchar(255), anydb boolean)";

/** The query that is executed when a user is authenticated */
static const char gssapi_auth_query[] = "SELECT * FROM " GSSAPI_TABLE_NAME
...
/** The insert query which adds users to the gssapi_users table */
static const char insert_sql_pattern[] = "INSERT INTO " GSSAPI_TABLE_NAME " VALUES ('%s', '%s', %s, %s)";
